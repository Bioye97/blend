...
int main(void)
{
    ...
    set_vertex(&data, 0, 35, 0);
    set_vertex(&data, 1, 65, 0);
    set_vertex(&data, 2, 99, 35);
    set_vertex(&data, 3, 99, 65);
    set_vertex(&data, 4, 65, 99);
    set_vertex(&data, 5, 35, 99);
    set_vertex(&data, 6, 0, 65);
    set_vertex(&data, 7, 0, 35);
