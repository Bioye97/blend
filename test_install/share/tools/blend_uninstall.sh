...
remove_path "${includedir}/blend_api.h"
remove_path "${includedir}/blend_boundary.h"
remove_path "${includedir}/blend_contribution.h"
remove_path "${includedir}/blend_error.h"
remove_path "${includedir}/blend_polygon.h"
remove_path "${includedir}/blend_report.h"
remove_path "${includedir}/blend_utils.h"
remove_path "${includedir}/blend_version.h"
remove_path "${includedir}/blend_window.h"
...
remove_path "${cmakedir}/blend-targets-noconfig.cmake"
...
remove_path "${docdir}/COPYINGv3"
remove_path "${docdir}/COPYING.LESSERv3"
...
for example_file in \
	...
	"${docdir}"/examples/*/*.gp \
	"${docdir}"/examples/*/*.sh \
	"${docdir}"/examples/*/*.blend \
	"${docdir}"/examples/*/*.txt \
	"${docdir}"/examples/*/*.png; do
	remove_path "${example_file}"
done

remove_dir_tree "${docdir}/html"
remove_dir_tree "${docdir}/rst"

remove_path "${tooldir}/blend_uninstall.sh"

for example_dir in "${docdir}"/examples/*; do
